...
def run(dest_dir: str) -> None:
    ...
    walden_ds = WaldenCatalog().find_one(namespace="ggdc", short_name="ggdc_pwt", version="2021-01-15")
    ...
    ds.metadata.version = "2022-11-08"
    ...
    tb.update_metadata_from_yaml(N.metadata_path, "ggdc_pwt")
